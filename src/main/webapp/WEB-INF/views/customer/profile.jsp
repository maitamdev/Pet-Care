...
<main class="main-content" style="margin:0 auto;">
    <div class="content-wrapper">
        <div class="card-panel form-shell">
            ...
            <form method="POST" action="${pageContext.request.contextPath}/my/profile" style="margin-top:20px;">
                ...
                <div class="form-actions"><button class="btn btn-primary" type="submit"><i class="bi bi-save"></i> Lưu hồ sơ</button><a class="btn btn-secondary" href="${pageContext.request.contextPath}/my/appointments">Quay lại</a></div>
            </form>
        </div>
    </div>
</main>
